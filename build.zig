...
//! Build only the reviewed public components. No reference tree or game data is read.
...
pub fn build(b: *std.Build) void {
    ...
    for ([_][]const u8{ "build/toolchain.zig", "src/dkguard/args.zig", "src/dkguard/plan.zig", "src/dkguard/host.zig", "src/dkguard/gpu_lock.zig", "src/dkguard/supervise.zig" }) |path| {
