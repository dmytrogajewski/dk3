...
typedef enum {
    ...
    DK_FX_QUAKE, DK_FX_DEBRIS, DK_FX_SPOTLIGHT, DK_FX_WEAPON_RING, DK_FX_CRYO, DK_FX_SLUDGE, DK_FX_PSYCLAW, DK_FX_NOVABEAM, DK_FX_GIB, DK_FX_COUNT
} dkEffect_t;
/* Gold fragtype bits; a DK_FX_GIB burst carries them in dk3EffectDuration. */
enum { DK_FRAG_NOBLOOD = 1, DK_FRAG_ROBOTIC = 2, DK_FRAG_BONE = 4, DK_FRAG_ALWAYSGIB = 16, DK_FRAG_NEVERGIB = 32 };
enum {
