...
pub const Trace = struct { fraction: f32, end: data.Vec3, normal: data.Vec3, start_solid: bool = false, all_solid: bool = false, entity: u16 = 2047, slick: bool = false, ladder: bool = false };
