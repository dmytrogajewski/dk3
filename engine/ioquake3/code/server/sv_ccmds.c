...
#else
		/* dk3 campaign travel uses ordinary map commands. Keep its explicit
		 * game mode across starts, authored exits and save restoration. */
		if (sv_gametype->integer == GT_SINGLE_PLAYER) killBots = qtrue;
#endif
	}
