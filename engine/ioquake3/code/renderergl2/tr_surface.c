...
/* Keep the dispatch ABI uniform without calling through cast function pointers. */
#define SURFACE_DISPATCH(name) static void name##Dispatch(void *surface) { name(surface); }
SURFACE_DISPATCH(RB_SurfaceBad)
SURFACE_DISPATCH(RB_SurfaceFace)
SURFACE_DISPATCH(RB_SurfaceGrid)
SURFACE_DISPATCH(RB_SurfaceTriangles)
SURFACE_DISPATCH(RB_SurfacePolychain)
SURFACE_DISPATCH(RB_SurfaceMesh)
SURFACE_DISPATCH(RB_MDRSurfaceAnim)
SURFACE_DISPATCH(RB_IQMSurfaceAnim)
SURFACE_DISPATCH(RB_SurfaceFlare)
SURFACE_DISPATCH(RB_SurfaceEntity)
SURFACE_DISPATCH(RB_SurfaceVaoMdvMesh)
SURFACE_DISPATCH(RB_IQMSurfaceAnimVao)
#undef SURFACE_DISPATCH

void (*rb_surfaceTable[SF_NUM_SURFACE_TYPES])( void *) = {
	RB_SurfaceBadDispatch,			// SF_BAD, 
	RB_SurfaceSkip,			// SF_SKIP, 
	RB_SurfaceFaceDispatch,			// SF_FACE,
	RB_SurfaceGridDispatch,			// SF_GRID,
	RB_SurfaceTrianglesDispatch,		// SF_TRIANGLES,
	RB_SurfacePolychainDispatch,		// SF_POLY,
	RB_SurfaceMeshDispatch,			// SF_MDV,
	RB_MDRSurfaceAnimDispatch,		// SF_MDR,
	RB_IQMSurfaceAnimDispatch,		// SF_IQM,
	RB_SurfaceFlareDispatch,		// SF_FLARE,
	RB_SurfaceEntityDispatch,		// SF_ENTITY
	RB_SurfaceVaoMdvMeshDispatch,   // SF_VAO_MDVMESH
	RB_IQMSurfaceAnimVaoDispatch,   // SF_VAO_IQM
};
