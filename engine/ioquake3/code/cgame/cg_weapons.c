...
#ifdef DK3_GAME
    DK_DrawPlayerWeapon(parent, cent);
    return;
#endif
	refEntity_t	gun;
	refEntity_t	barrel;
...
#ifdef DK3_GAME
    /* The dk3 HUD presents the current weapon and ammunition. */
    return;
#endif
	int		i;
	int		bits;
...
#ifdef DK3_GAME
    DK_SelectWeapon(0, atoi(CG_Argv(1)));
    return;
#endif
	int		num;
