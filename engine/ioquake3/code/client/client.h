...
typedef struct {
	...
	dkq3EntityExt_t	parseEntityExts[MAX_PARSE_ENTITIES];	// dkq3 entity extension state beside each parseEntities entry
} clientActive_t;
...
typedef struct {
	...
	qboolean	dkq3_ext;		// dkq3 entity extension negotiated by this session's gamestate (CL_ParseGamestate)
