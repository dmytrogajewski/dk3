...
typedef enum {
	...
	GT_OBELISK,
	GT_HARVESTER,
	GT_DK3_DEATHTAG,     // timed team bomb delivery
	GT_MAX_GAME_TYPE
} gametype_t;
...
typedef enum {
	...
	PW_AMMOREGEN,
	PW_INVULNERABILITY,
	PW_DK3_GASHANDS, /* dk3: campaign expiry; zero means untimed multiplayer. */
