...
#ifdef DK3_GAME
        DK_LoadGroundNavigation(mapname.string);
#else
...
#ifdef DK3_GAME
    trap_BotLibVarSet("dk3_navigation", "1");
#endif
...
int BotAIShutdown( int restart ) {
	...
	int i;
#ifdef DK3_GAME
	/* The library survives map_restart, but native module state may not. */
	for (i = 0; i < MAX_CLIENTS; ++i) DK_DisconnectBot(i);
#endif
