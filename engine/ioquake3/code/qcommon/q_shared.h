...
#if defined(STANDALONE) || defined(DK3_GAME)
  #define PRODUCT_NAME				"dk3"
  #define BASEGAME					"dk3"
  #define CLIENT_WINDOW_TITLE		"dk3"
  #define CLIENT_WINDOW_MIN_TITLE	"dk3"
  #define HOMEPATH_NAME_UNIX_LEGACY	".dk3"
  #define HOMEPATH_NAME				"dk3"
  #define GAMENAME_FOR_MASTER		"dk3"	// must NOT contain whitespace
  #define CINEMATICS_LOGO		""
  #define CINEMATICS_INTRO		"intro.roq"
//  #define LEGACY_PROTOCOL	// You probably don't need this for your standalone game
  #define CONFIG_PREFIX			"dk3config"
#else
...
#define	GENTITYNUM_BITS		11		// dk3 maps plus actors, projectiles and temporary effects
...
#define MAX_MODELS 512  // dk3: 9-bit model indices
#define MAX_SOUNDS 1024 // dk3: 10-bit sound indices
...
#define MAX_GAMESTATE_CHARS (128 * 1024)
typedef struct {
...
typedef struct playerState_s {
    ...
    // dk3 protocol 1340: explicit campaign state, shared by native and VM modules.
    int dk3Objective;
    int dk3ObjectiveUntil;
    int dk3Inventory;
    int dk3Experience;
    int dk3Level;
    int dk3Attributes[5];
    ...
    vec3_t dk3CameraAngles;
    float dk3CameraFov;
    float dk3CameraBlend[4];
...
typedef struct entityState_s {
    ...
    int dk3SoundFlags;
    float dk3Scale, dk3Alpha;
    /* Protocol 1343: authored actor axes and simulation-time animation. */
    vec3_t dk3ModelScale;
    int dk3AnimationStart, dk3AnimationFirst, dk3AnimationLast;
    int dk3AnimationRate, dk3AnimationLoop;
    int dk3RenderFlags;
    int dk3Effect, dk3EffectFlags, dk3EffectStart, dk3EffectDuration;
    float dk3EffectRate, dk3EffectSpeed, dk3EffectSpread, dk3EffectRadius;
    vec3_t dk3EffectColor, dk3EffectMins, dk3EffectMaxs, dk3EffectEnd, dk3EffectGravity;
	int		modelindex;
	int		modelindex2;
