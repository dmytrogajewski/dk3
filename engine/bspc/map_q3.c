...
//		side_brushtextures[nummapbrushsides] = td;
	...
	/* dk3 preserves authored ladders as SURF_LADDER on converted brush
	   sides. Quake III's contents bit at CONTENTS_LADDER means translucent,
	   so derive the internal AAS ladder classification from surfaces only. */
