...
// Changes Globals:		-
//===========================================================================
qboolean PlaneUsedByParent (int pnum, node_t *node)
{
	node_t	*p;
...
//					continue;	// only check visible faces on first pass
                ...
                /* An ancestor already bounds this volume by this plane. Expanded
                   collision brushes may retain the same face after epsilon clipping;
                   it is a boundary, never a candidate for another partition. */
                if (PlaneUsedByParent(pnum, node)) {
